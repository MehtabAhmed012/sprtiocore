...
const stats = [
  ...
  { value: 20, label: 'Industries', suffix: '+' },
...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden topo-bg">
      {/* Background Overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-bg-light/80 via-transparent to-bg-light dark:from-bg-dark/80 dark:via-transparent dark:to-bg-dark z-0" />
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10 w-full">
        ...
        >
          ...
          <motion.h1 
            ...
            className="font-display text-5xl md:text-7xl lg:text-8xl font-black mb-8 leading-[0.95] tracking-[-3px] text-white"
          >
            Where Earth Data Meets <br /><span className="text-primary">Smart Solutions</span>
          </motion.h1>
          ...
          <motion.p 
            ...
            className="text-lg md:text-xl text-text-muted leading-relaxed max-w-lg mb-12"
          >
            SpatioCore Tech delivers precision GIS, Remote Sensing, and environmental mapping services — transforming complex spatial data into clear, actionable intelligence.
          </motion.p>
          ...
          >
            <a href="#services" className="btn-sophisticated btn-primary flex items-center gap-3">
          ...
          >
            {stats.map((stat) => (
              <div key={stat.label}>
                ...
                <div className="text-xs font-mono uppercase tracking-wider text-text-light/50 dark:text-text-dark/50">
                  {stat.label}
                </div>
              </div>
            ))}
